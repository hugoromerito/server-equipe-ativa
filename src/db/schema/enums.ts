...
const ROLE_VALUES = ['ADMIN', 'MANAGER', 'CLERK', 'ANALYST', 'BILLING'] as const

const ACCOUNT_PROVIDER_VALUES = ['FACEBOOK', 'GITHUB', 'GOOGLE'] as const

const TOKEN_TYPE_VALUES = ['PASSWORD_RECOVER', 'EMAIL_VERIFICATION'] as const
